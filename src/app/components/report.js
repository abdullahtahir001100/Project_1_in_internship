...
export default function DashboardPage() {
  ...
  async function fetchReportData() {
    try {
      const response1 = await axios.get('https://myproject2.xo.je/api/Posts/get_department.php'); // Departments
      const response2 = await axios.get('https://myproject2.xo.je/api/Posts/get'); // Posts
      const response3 = await axios.get('https://myproject2.xo.je/api/bonus/get.php'); // Bonuses
      const response4 = await axios.get('https://myproject2.xo.je/api/deduction/get.php'); // Deductions
      const response6 = await axios.get('https://myproject2.xo.je/api/Employees/get.php'); // Employees
