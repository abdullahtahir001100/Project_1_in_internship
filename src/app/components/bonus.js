...
export default function Bonus() {
    ...
    async function handlePost() {
        ...
        try {
            ...
            const res = await axios.post(`https://myproject2.xo.je/api/bonus/${url}`, payload);
            get_table_data();
            setIsOpen(false);
    ...
    async function get_edit_data(id) {
        try {
            const res = await axios.get(`https://myproject2.xo.je/api/bonus/get.php?id=${id}`);
    ...
    async function handleDelete(id) {
        try {
            const res = await axios.post(`https://myproject2.xo.je/api/bonus/delete.php`, { id });
