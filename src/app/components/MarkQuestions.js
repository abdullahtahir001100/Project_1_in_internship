...
export default function MarkQuestions({ empId, onBack }) {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                setLoading(true);
                const empRes = await axios.get(`https://myproject2.xo.je/api/Employees/get_data.php?id=${empId}`);
                const emp = empRes.data;
                setEmployee(emp);

                const qRes = await axios.get(`https://myproject2.xo.je/api/questions/get.php?department_id=${emp.department_id}`);
    ...
    async function handleSave() {
        try {
            ...
            const res = await axios.post('https://myproject2.xo.je/api/questions/save_rating.php', payload);
    ...
    async function get_existing_rating() {
        try {
            const res = await axios.get(
                `https://myproject2.xo.je/api/questions/get_rating.php?employee_id=${empId}`
            );
    ...
    return (
        <div className="section-container">
            ...
            <div className="emp-modal-footer">
                ...
                <button type="button" className="btn-save" onClick={handleSave}>Save Ratings</button>
            </div>
