...
export default function Resignation() {
    ...
    async function getResignations() {
        try {
            setLoading(true);
            const response = await axios.get('http://localhost/react-backend/api/reasons/get.php');
    ...
    async function handleDelete(id) {
        try {
            setLoading(true);
            await axios.delete('http://localhost/react-backend/api/reasons/delete.php', {
                data: { id: id }
            });
    ...
    async function handleUpdate() {
        ...
        try {
            ...
            await axios.put('http://localhost/react-backend/api/reasons/update.php', payload);
