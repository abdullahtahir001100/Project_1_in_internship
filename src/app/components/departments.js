...
export default function Departments() {
    ...
    const fetchAll = async () => {
        setLoading(true);
        try {
            const res = await axios.get('https://php-production-c3d6.up.railway.app/api/Posts/get_department.php');
            setData(res.data);
        }
        catch (err) {
    ...
    const openModal = async (id = null) => {
        ...
        if (id) {
            try {
                const res = await axios.get(`https://php-production-c3d6.up.railway.app/api/departments/get.php?id=${id}`);
    ...
    const handleSave = async (e) => {
        ...
        try {
            const res = await axios.post(`https://php-production-c3d6.up.railway.app/api/departments/${url}`, fd);
    ...
    const handleDelete = async () => {
        await axios.delete('https://php-production-c3d6.up.railway.app/api/departments/delete.php', { data: { id: targetId } });
